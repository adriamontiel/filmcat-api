...
export const REGISTRY = [
  // ─── OCINE (filazero) ────────────────────────────────────────────────────
  { filmcat_name: 'Ocine Arenys',                                            system: 'filazero', domain: 'www.ocinearenys.es',        web: 'https://ocinearenys.es' },
  { filmcat_name: 'Ocine Blanes',                                            system: 'filazero', domain: 'www.ocineblanes.es',        web: 'https://ocineblanes.es' },
  { filmcat_name: 'Ocine El Vendrell \u2013 Les Mates',                      system: 'filazero', domain: 'www.ocinevendrell.es',      web: 'https://ocinevendrell.es' },
  { filmcat_name: 'Ocine Girona',                                            system: 'filazero', domain: 'www.ocinegirona.es',        web: 'https://ocinegirona.es' },
  { filmcat_name: 'Ocine Granollers - El Nord',                              system: 'filazero', domain: 'www.ocinegranollers.es',    web: 'https://ocinegranollers.es' },
  { filmcat_name: 'Ocine M\u00e0gic Badalona',                              system: 'filazero', domain: 'www.ocinemagic.es',         web: 'https://ocinemagic.es' },
  { filmcat_name: "Ocine Platja d'Aro \u2013 Parc d'Aro",                   system: 'filazero', domain: 'www.ocineplatjadaro.es',    web: 'https://ocineplatjadaro.es' },
  { filmcat_name: 'Ocine Premium Lleida',                                    system: 'filazero', domain: 'www.ocinepremiumlleida.es', web: 'https://ocinepremiumlleida.es' },
  { filmcat_name: 'Ocine Roquetes',                                          system: 'filazero', domain: 'www.ocineroquetes.es',      web: 'https://ocineroquetes.es' },
  { filmcat_name: 'Ocine Tarragona - Les Gavarres',                          system: 'filazero', domain: 'www.ocinegavarres.es',      web: 'https://ocinegavarres.es' },
  { filmcat_name: 'Ocine Vila-seca \u2013 Port Halley',                      system: 'filazero', domain: 'www.ocinevilaseca.es',      web: 'https://ocinevilaseca.es' },
  ...
  // ─── BIZCOCHITO (Admit One Spain) ────────────────────────────────────────
  { filmcat_name: 'Cinemes Sant Cugat',                                      system: 'bizcochito', domain: 'www.cinemessantcugat.com',    web: 'https://www.cinemessantcugat.com' },
  { filmcat_name: 'Cinemes Can Castellet de Sant Boi de Llobregat',          system: 'bizcochito', domain: 'www.cinemescancastellet.com', web: 'https://www.cinemescancastellet.com' },
  { filmcat_name: 'MCB Cinema Calafell',                                     system: 'bizcochito', domain: 'www.mcbcinemas.com',          web: 'https://www.mcbcinemas.com' },
