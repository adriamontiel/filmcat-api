...
export const REGISTRY = [
  // ─── OCINE (sense font — bloqueja IPs cloud i GitHub Actions) ───────────
  { filmcat_name: 'Ocine Arenys',                                            system: 'none', domain: null, web: 'https://ocinearenys.es' },
  { filmcat_name: 'Ocine Blanes',                                            system: 'none', domain: null, web: 'https://ocineblanes.es' },
  { filmcat_name: 'Ocine El Vendrell \u2013 Les Mates',                      system: 'none', domain: null, web: 'https://ocinevendrell.es' },
  { filmcat_name: 'Ocine Girona',                                            system: 'none', domain: null, web: 'https://ocinegirona.es' },
  { filmcat_name: 'Ocine Granollers - El Nord',                              system: 'none', domain: null, web: 'https://ocinegranollers.es' },
  { filmcat_name: 'Ocine M\u00e0gic Badalona',                              system: 'none', domain: null, web: 'https://ocinemagic.es' },
  { filmcat_name: "Ocine Platja d'Aro \u2013 Parc d'Aro",                   system: 'none', domain: null, web: 'https://ocineplatjadaro.es' },
  { filmcat_name: 'Ocine Premium Lleida',                                    system: 'none', domain: null, web: 'https://ocinepremiumlleida.es' },
  { filmcat_name: 'Ocine Roquetes',                                          system: 'none', domain: null, web: 'https://ocineroquetes.es' },
  { filmcat_name: 'Ocine Tarragona - Les Gavarres',                          system: 'none', domain: null, web: 'https://ocinegavarres.es' },
  { filmcat_name: 'Ocine Vila-seca \u2013 Port Halley',                      system: 'none', domain: null, web: 'https://ocinevilaseca.es' },
